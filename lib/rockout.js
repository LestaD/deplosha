...
exports.perform = function (cmd) {
  if (deplosha.kits[deplosha.env]) {
    deplosha.kits[deplosha.env]();
  }
 ...
 */
Deplosha.prototype.envKit = function (env, cb) {
  if (typeof cb !== 'function') throw new Error('Environment kit must be Function! Try set: ' + env);

  deplosha.kits[env] = cb;
}
